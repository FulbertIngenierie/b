...
var gun_sound: AudioStreamPlayer3D
...
func _ready():
	# Initialiser les nœuds optionnels
	head = get_node_or_null("Head")
	anim_player = get_node_or_null("CharacterModel/AnimationPlayer")
	gun_sound = get_node_or_null("ShootSound")
	gun_tip = head
