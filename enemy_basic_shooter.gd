...
@onready var anim_player = $BotModel/AnimationPlayer
...
func can_see_player():
	...
	var ray_end = player.global_position
...
func shoot_at_player():
	...
	# Animation de tir - utiliser les animations existantes du modèle
	if anim_player:
		if anim_player.has_animation("Take 001"):
			anim_player.speed_scale = 1.0
			anim_player.stop()
			anim_player.play("Take 001")
			current_anim = "Take 001"
		elif anim_player.has_animation("mixamo_com"):
			anim_player.speed_scale = 1.0
			anim_player.stop()
...
func create_impact(pos, normal):
	...
	if impact and get_tree().current_scene:
...
func reload():
	...
	# Animation de rechargement - utiliser les animations existantes du modèle
	if anim_player:
		if anim_player.has_animation("Take 001"):
			anim_player.play("Take 001")
		elif anim_player.has_animation("mixamo_com"):
...
func take_damage(amount):
	...
	# Animation de réaction aux dégâts - utiliser les animations existantes du modèle
	if anim_player:
		if anim_player.has_animation("Take 001"):
			anim_player.play("Take 001")
		elif anim_player.has_animation("mixamo_com"):
